...
SUBTYPE_INFO = {
    1: {
        ...
        "risk_level": "中风险",
        "risk_color": "🟡",
        "main_features": "神疲（100.00%）+ 苔白（99.42%）",
        "secondary_features": "痰热壅肺证罕见（1.75%），病程≥10年比例最低（20.47%），超重比例及肥胖比例在各亚型中均最低（25.15%、9.36%），红细胞计数正常比例在各亚型中最高（58.48%），血小板分布宽度正常患者占比在各亚型中最高（94.15%），红细胞计数正常占比最高（58.48%）"
    },
    2: {
        "name": "亚型2",
        "full_name": "神疲为主",
        ...
        "risk_level": "高风险",
        "risk_color": "🔴",
        "main_features": "神疲为主要表现（86.45%）",
        "secondary_features": "仅11.61%出现苔白，16.77%出现痰热壅肺证，年龄≥65岁比例在各亚型中最高（60.65%），红细胞计数偏高比例在各亚型中最高（16.77%），高密度脂蛋白胆固醇偏低比例在各亚型中最低（16.77%）"
    },
    3: {
        "name": "亚型3",
        "full_name": "中医特征不显著",
        ...
        "secondary_features": "痰热壅肺证（7.44%）、神疲（0.40%）、苔白（13.68%）发生率均较低，病程≥10年比例在各亚型中最高（34.00%），红细胞计数偏低比例在各亚型中最高（64.99%），中性粒细胞比率偏高比例在各亚型中最高（37.63%），淋巴细胞比率偏低比例在各亚型中最高（43.06%），嗜酸性粒细胞比率偏低比例在各亚型中最高（30.38%），载脂蛋白A偏高比例在各亚型中最高（18.91%），载脂蛋白B偏高比例在各亚型中最高（20.93%），高密度脂蛋白胆固醇偏高比例在各亚型中最高（26.76%）"
    },
    4: {
        "name": "亚型4",
        "full_name": "痰热壅肺证为主",
        ...
        "secondary_features": "神疲（1.08%）和苔白（6.14%）发生率极低，年龄≥65岁比例在各亚型中最低（41.88%），肥胖比例在各亚型中最高（16.97%），血小板分布宽度偏低比例在各亚型中最高（41.52%），尿酸偏高比例在各亚型中最高（22.74%）"
    },
    5: {
        "name": "亚型5",
        "full_name": "苔白为主",
        ...
        "secondary_features": "痰热壅肺证（3.01%）和神疲（0%）发生率极低，痰黄发生率在各亚型中最低（16.17%），BMI偏低比例在各亚型中最高（15.04%），嗜酸性粒细胞比率偏高比例在各亚型中最高（8.27%），白蛋白偏低比例在各亚型中最高（56.77%），载脂蛋白A偏低比例在各亚型中最高（11.28%），高密度脂蛋白胆固醇偏低比例在各亚型中最高（22.56%）"
    },
    6: {
        "name": "亚型6",
        "full_name": "痰热壅肺证合并神疲为主",
        "readmission_rate": 17.06,
        "risk_level": "中风险",
        "risk_color": "🟡",
        "main_features": "痰热壅肺证（90.00%）+ 神疲（97.65%）",
        "secondary_features": "仅4.71%出现苔白，痰黄发生率在各亚型中最高（53.53%），超重比例在各亚型中最高（36.47%），载脂蛋白B偏低比例在各亚型中最高（13.53%）"
    }
}
...
jing_shen_wei_mi = st.sidebar.selectbox(
    ...
    options=[0, 1],
    format_func=lambda x: "无" if x == 0 else "有",
    help="患者是否出现神疲症状（精神不振、倦怠乏力、反应迟钝等）"
)
...
fev1_fvc = st.sidebar.selectbox(
    "FEV1/FVC比值", 
    options=[2, 3, 4],
    format_func=lambda x: {2: "轻度 (≥60% 但 <70%)", 
                           3: "中度 (≥50% 但 <60%)", 
                           4: "重度 (<50%)"}[x],
    help="""
    FEV1/FVC比值分级：
...
if predict_button:
    ...
    try:
        ...
        # 特征顺序：痰热壅肺证, 神疲, 苔白, 高密度脂蛋白胆固醇, FEV1/FVC, 血小板分布宽度
...
with st.expander("ℹ️ 各亚型详细特征及临床意义"):
    ...
    |------|----------|----------|----------|----------|--------------|
    | 亚型1 | 神疲合并苔白为主 | 14.62% | 🟡 中风险 | 神疲(100%) + 苔白(99.42%) | 
    | 亚型2 | 神疲为主 | **20.65%** | 🔴 高风险 | 神疲为主(86.45%) |
    | 亚型3 | 特征不显著 | 12.27% | 🟢 低风险 | 中医特征不明显(人数最多) |
    | 亚型4 | 痰热壅肺证为主 | **11.19%** | 🟢 低风险 | 痰热壅肺证为主(82.31%) |
    | 亚型5 | 苔白为主 | 12.78% | 🟢 低风险 | 苔白为主(78.95%) |
    | 亚型6 | 痰热壅肺证合并神疲为主 | 17.06% | 🟡 中风险 | 痰热壅肺证(90%) + 神疲(97.65%) |
