...
if predict_button:
    ...
    try:
        ...
        # 特征顺序：平均血红蛋白量, 载脂蛋白A, 尿酸, FVC占最佳预计值的百分比, 发热, 痰热壅肺证
...
with st.expander("ℹ️ 各亚型特征及临床意义"):
    ...
    | 亚型2 | 14.5% | 🟡 中等风险 | 痰热壅肺证(-) + 发热(-) | 定期随访和预防性治疗，建议1-2月复诊 |
    | 亚型3 | 14.0% | 🟡 中等风险 | 痰热壅肺证(-) + 发热(+) | 定期随访和预防性治疗，建议1-2月复诊 |
...
with st.expander("📖 使用说明"):
    ...
    **性能评价：**
    - 训练集表现完美，说明模型拟合良好
    - 测试集和时段验证集AUC均>0.94，说明泛化能力强
    - Micro-AUC和Macro-AUC接近，说明对各亚型预测均衡
